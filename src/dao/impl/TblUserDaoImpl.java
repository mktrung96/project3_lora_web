...
//
///**
// * Class TblUser là Java Bean chứa các thuộc tính của bảng tbl_user trong db
// * 
// * 
// */
...
//	 */
//	@Override
//	public ArrayList<DisplayInfo> getListUser(int offset, int limit, int groupId, String fullName, String sortType,
//			String sortByFullName, String sortByCodeLevel, String sortByEndDate)
//			throws SQLException, ClassNotFoundException {
//		try {
//			// khởi tạo danh sách trả về
//			ArrayList<DisplayInfo> listUserInfo = new ArrayList<>();
//			// mở kết nối tới database
//			openMySQLConnection();
//			// nếu Connection đã có thì thực thi dòng câu lệnh phía dưới
//			if (conn != null) {
...
//					displayInfo.setUserID(rs.getInt(Constant.TBL_USER_USER_ID));
//					displayInfo.setFullName(rs.getString(Constant.TBL_USER_FULLNAME));
//					displayInfo.setBirthday(rs.getDate(Constant.TBL_USER_BIRTHDAY));
//					displayInfo.setGroupName(rs.getString(Constant.MST_GROUP_GROUP_NAME));
//					displayInfo.setEmail(rs.getString(Constant.TBL_USER_EMAIL));
//					displayInfo.setTel(rs.getString(Constant.TBL_USER_TEL));
//					displayInfo.setNameLevel(rs.getString(Constant.MST_JAPAN_NAME_LEVEL));
//					displayInfo.setEndDate(rs.getDate(Constant.TBL_DETAIL_END_DATE));
//					displayInfo.setTotal(String.valueOf(rs.getInt(Constant.TBL_DETAIL_TOTAL)));
//					listUserInfo.add(displayInfo);
//				}
...
//	 */
//	@Override
//	public DisplayInfo getUserInfoById(int userID) throws SQLException, ClassNotFoundException {
//		try {
//			openMySQLConnection();
//			if (conn != null) {
//				StringBuilder sql = new StringBuilder();
...
//				DisplayInfo displayInfo = new DisplayInfo();
//				if (rs.next()) {
//					displayInfo.setLoginName(rs.getString(Constant.TBL_USER_LOGIN_NAME));
//					displayInfo.setGroupId(rs.getInt(Constant.TBL_USER_GROUP_ID));
//					displayInfo.setFullName(rs.getString(Constant.TBL_USER_FULLNAME));
//					displayInfo.setKanaName(rs.getString(Constant.TBL_USER_FULLNAME_KANA));
//					displayInfo.setBirthday(rs.getDate(Constant.TBL_USER_BIRTHDAY));
//					displayInfo.setEmail(rs.getString(Constant.TBL_USER_EMAIL));
//					displayInfo.setTel(rs.getString(Constant.TBL_USER_TEL));
//					String codeLevel = rs.getString(Constant.TBL_DETAIL_CODE_LEVEL);
//					displayInfo.setCodeLevel(codeLevel);
//					if (codeLevel != "") {
//						displayInfo.setStartDate(rs.getDate(Constant.TBL_DETAIL_START_DATE));
//						displayInfo.setEndDate(rs.getDate(Constant.TBL_DETAIL_END_DATE));
//						displayInfo.setTotal(String.valueOf(rs.getInt(Constant.TBL_DETAIL_TOTAL)));
//					}
//				}
