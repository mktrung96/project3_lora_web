...
//	 */
//	public List<String> checkValidateADM001(String userName, String password)
...
//	 * @throws Exception
//	 */
//	public List<String> validateUserInfor(DisplayInfo displayInfo) throws Exception {
//		List<String> listError = new ArrayList<>();
//		int userID = displayInfo.getUserID();
//		String loginName = displayInfo.getLoginName();
//		int groupId = displayInfo.getGroupId();
//		String fullName = displayInfo.getFullName();
//		String kanaName = displayInfo.getKanaName();
//		List<Integer> arrBirthDay = displayInfo.getArrBirthDay();
//		String email = displayInfo.getEmail();
//		String tel = displayInfo.getTel();
//		String passWord = displayInfo.getPassWord();
//		String confirmPassWord = displayInfo.getConfirmPassWord();
//
//		String codeLevel = displayInfo.getCodeLevel();
//		List<Integer> arrStartDate = displayInfo.getArrStartDate();
//		List<Integer> arrEndDate = displayInfo.getArrEndDate();
//		String total = displayInfo.getTotal();
...
//	 */
//	public boolean checkValidateUserInfoDB(DisplayInfo displayInfo) {
//		boolean flag = true;
//		TblUserLogic tblUserLogicImpl = new TblUserLogicImpl();
//		MstJapanLogic mstJapanLogicImpl = new MstJapanLogicImpl();
//		try {
//			if (displayInfo.getUserID() == 0) {
//				// kiểm tra loginName tồn tại trong DB
//				if (tblUserLogicImpl.checkExistedLoginName(displayInfo.getLoginName())) {
//					System.out.println("login đã tồn tại");
//					flag = false;
//				}
//			}
//			// kiểm tra nhóm tồn tại trong DB
//			if (!tblUserLogicImpl.checkExistedGroupId(displayInfo.getGroupId())) {
//				System.out.println("nhóm không tồn tại");
//				flag = false;
//			}
//			// kiểm tra email tồn tại trong DB
//			if (tblUserLogicImpl.checkExistedEmail(displayInfo.getEmail(), displayInfo.getUserID())) {
//				System.out.println("mail đã tồn tại");
//				flag = false;
//			}
//			// kiểm tra sự tồn tại của trình độ tiếng Nhật trong DB
//			if (!mstJapanLogicImpl.checkExistLevelJapan(displayInfo.getCodeLevel())) {
